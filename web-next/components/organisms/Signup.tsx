...
export default function Signup({ onSubmit }: { onSubmit: (data: { email: string; password: string; name: string }) => void }) {
    ...
    return (
        <div className="flex flex-col items-center gap-4 p-6 rounded shadow-md">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md">
                ...
                <div className="flex flex-col">
                    <label htmlFor="name" className="mb-1 font-medium">Prénom</label>
                    <Input type={InputType.TEXT} value={name} onChange={(e) => setName(e.target.value)} />
                </div>
